...
public class ChangeYSizeAnimation extends Animation {
    ...
    /**
     * @param view
     *            - view to be processed, should NOT be null.
     * @param heightSpec
     *            - HeightSpec instance to describe target height in pixels for
     *            the view (this doesn't touch view margins). Can be null.
     * @param marginSpec
     *            - MarginSpec instance to describe target top/bottom margins in
